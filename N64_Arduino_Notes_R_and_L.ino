...
#define NOTE_D4 294 //3 (A Button)
#define NOTE_DS4 311 //4
#define NOTE_E4 330 //5
#define NOTE_F4 349 //6 (C Down)
#define NOTE_FS4 370 //7
#define NOTE_G4 392 //8
#define NOTE_GS4 415 //9
#define NOTE_A4 440 //10 (C Right)
#define NOTE_AS4 466 //11
#define NOTE_B4 494 //12 (C Left)
#define NOTE_C5 523 //13 
#define NOTE_CS5 554 //14
#define NOTE_D5 587 //15 (C Up)
#define NOTE_DS5 622 //16
#define NOTE_E5 659 //17
#define NOTE_F5 698 //18
...
int notes[19] = {NOTE_B3, NOTE_C4, NOTE_CS4, NOTE_D4, NOTE_DS4, NOTE_E4, NOTE_F4, NOTE_FS4, NOTE_G4, NOTE_GS4, NOTE_A4, NOTE_AS4, NOTE_B4, NOTE_C5, NOTE_CS5, NOTE_D5, NOTE_DS5, NOTE_E5, NOTE_F5};
...
void play_note_of_buttons() {
    int noteRate = 25;
    // Resolve Z and R:
    bool zPressed = N64_status.data1 & 32;
    bool rPressed = N64_status.data2 & 16;
    bool stickUp = N64_status.stick_y > 50;
    bool stickDown = N64_status.stick_y < -50;
    bool stickRight = N64_status.stick_x > 50;
    bool stickLeft = N64_status.stick_x < -50;

    // Unused Buttons:
    // B is unused:
    //bool b == N64_status.data1 & 64;
    // L is unused:
    //bool LPressed = N64_status.data2 & 32;

    // Ocarina Buttons:
    
    bool cUpPressed = N64_status.data2 & 0x08;
    bool cLeftPressed = (N64_status.data2 & 0x02) && !cUpPressed; // Play the highest note only
    bool cRightPressed = (N64_status.data2 & 0x01) && !cLeftPressed;
    bool cDownPressed = (N64_status.data2 & 0x04) && !cRightPressed;
    bool aPressed = (N64_status.data1 & 128) && !cDownPressed;
    ...
    if(aPressed) {
        rootNote = 3;
    } else if(cDownPressed) {
        rootNote = 6;
    } else if(cRightPressed) {
        rootNote = 10;
    } else if(cLeftPressed) {
        rootNote = 12;
    } else if(cUpPressed) {
        rootNote = 15;
    }
    ...
    if(stickLeft) {
        noteRate = noteRate - 14;
    }


    if(rootNote != -1) {
        tone(SPEAKER_PIN, notes[rootNote + modifier], noteRate);
    } else {
        noTone(SPEAKER_PIN);
    }
...
void loop()
{
   ...
   for (i=0; i<16; i++) {
    ...
    Serial.print(" \n");
    if(N64_status.stick_y > 50) {
        Serial.print("Y Up");
    } else if(N64_status.stick_y < -50) {
        Serial.print("Y Down");
    }
   //   Serial.print("         Stick X:");
 //   Serial.print(N64_status.stick_x, DEC);
